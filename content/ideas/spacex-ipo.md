---
title: How COTS Changed the Space Economy
date: 2026-06-08
---
...
1. The first called for a return to a centralized, government-led program with ambitions comparable to those of the Apollo era. This approach was represented by the Constellation program, which envisioned a rocket similar in size to the Saturn V, a lunar lander, and a vehicle capable of transporting crew and cargo to the International Space Station. Its broader objective was to return humans to the Moon, establish a sustained lunar presence, and use it as a stepping stone to Mars.
2. The second approach sought to create a larger role for the private sector. This philosophy was advanced through initiatives such as the Commercial Space Launch Amendments Act of 2004 and President George W. Bush's Aldridge Commission. One of the commission's recommendations was for NASA to purchase services from private companies rather than own and operate every component of the space program itself.
...
1. It used fixed-price agreements rather than reimbursing costs plus a guaranteed margin. This placed more financial risk on the companies but gave them a stronger incentive to operate efficiently.
2. NASA provided insight rather than direct oversight. Giving companies greater control over their own operations allowed them to develop and scale technologies through their own methods.
3. Companies were permitted to retain the intellectual property rights to the technologies they developed, introducing a more business-oriented approach to government space funding.
...
1. In 2010, SpaceX launched the Falcon 9 and demonstrated its ability to deliver spacecraft and cargo into orbit.
2. In 2012, the Dragon capsule became the first commercial spacecraft to reach and dock with the International Space Station, fulfilling a central objective of SpaceX's COTS agreement.
3. In 2015, SpaceX successfully landed the first stage of an orbital-class rocket. This achievement laid the foundation for partially reusable launch systems and helped dramatically reduce the cost of reaching space.
...
<div class="article-image-wrap">
  <img src="spacex-ipo.jpg" alt="How COTS Changed the Space Economy" class="article-img-small" />
</div>
